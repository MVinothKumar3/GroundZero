...
class _TetrisGameScreenState extends State<TetrisGameScreen>
  ...
  DateTime? _lastInterstitialLoad;
...
void _loadInterstitial() {
  ...
  if (_lastInterstitialLoad != null &&
      DateTime.now().difference(_lastInterstitialLoad!) <
          const Duration(seconds: 60)) {
    return; // ⛔ too soon
  }

  _lastInterstitialLoad = DateTime.now();
...
void _onGameStateChanged() {
  ...
  if (gameLogic.isGameOver && !_gameOverHandled) {
